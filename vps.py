...
def generate_key_command(message):
    ...
    if user_id in admin_id:
        ...
        response = "𝗖𝗼𝗻𝘁𝗮𝗰𝘁 𝗔𝗱𝗺𝗶𝗻 @VKP_950"
...
def execute_attack(user_id, target, port, time):
    ...
    try:
        ...
        full_command = f"./spyther {target} {port} {time} 900 "  # Replace with actual attack command
